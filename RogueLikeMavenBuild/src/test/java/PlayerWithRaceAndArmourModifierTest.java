...
public class PlayerWithRaceAndArmourModifierTest {
    ...
    private PlayableCharacter testDwarfPlayer;
    ...
    public void testHelmetWithDwarfRaceModifiers() {
        ...
        assertEquals(10 * testDwarfPlayer.getRace().getMagicModifier() * helmet.getMagicModifier(),
                testDwarfPlayer.getMagic(), "Magic should reflect combined Dwarf and Helmet modifiers."
        );
    }
    ...
    public void testChestplateWithDwarfRaceModifiers() {
        ...
        assertEquals(10 * testDwarfPlayer.getRace().getMagicModifier() * chestplate.getMagicModifier(),
                testDwarfPlayer.getMagic(), "Magic should reflect combined Dwarf and Chestplate modifiers."
        );
    }
    ...
    public void testTrinketWithDwarfRaceModifiers() {
        ...
        assertEquals(10 * testDwarfPlayer.getRace().getStrengthModifier() * trinket.getStrengthModifier(),
                testDwarfPlayer.getStrength(), "Strength should reflect combined Dwarf and Trinket modifiers."
        );
